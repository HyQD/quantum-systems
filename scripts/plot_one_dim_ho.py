...
dw = OneDimensionalHarmonicOscillator(
    n, l, 6, num_grid_points,
)
dw.setup_system(potential=DWPotential(omega, length_of_dw))
...
helium_ion = OneDimensionalHarmonicOscillator(
    n, l, grid_length, num_grid_points, a=0.7408
)
